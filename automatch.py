...
def automatch(inputfile, referencefile, outputfile, feature_name, gcps, show, tileX=None, tileY=None, offsetX=None, offsetY=None, ratio = 0.75, binary = False):
   ...
   if not feature_name:
      feature_name = 'brisk'
   img = georef(inputfile, referencefile, outputfile, feature_name, pointsShp, pointsTxt, tile, offset, ratio, binary)
...
if __name__ == "__main__":
    ...
    if args.ratio is not None:
       automatch(args.i, args.r, args.o, args.feature, args.gcps, args.show, args.tileX, args.tileY, args.offsetX, args.offsetY, args.ratio)
    else:
       automatch(args.i, args.r, args.o, args.feature, args.gcps, args.show, args.tileX, args.tileY, args.offsetX, args.offsetY)
